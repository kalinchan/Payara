...
public class XmppNotificationRunnable extends NotificationRunnable<XmppMessageQueue, XmppNotifierConfigurationExecutionOptions> {
    ...
    XmppNotificationRunnable(XmppMessageQueue queue, XmppNotifierConfigurationExecutionOptions executionOptions, XMPPTCPConnection connection) {
        this.queue = queue;
    ...
    public void uncaughtException(Thread t, Throwable e) {
        logger.log(Level.SEVERE, "Error occurred consuming XMPP messages from queue", e);
    }
}
