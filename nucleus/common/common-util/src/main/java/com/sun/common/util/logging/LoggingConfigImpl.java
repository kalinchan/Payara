...
/**
   ...
   @Override
    ...
    /**
     * @param usePlaceholderReplacement - true for placeholder replacement,
     * false returns original property value
     * @return a Map of all the properties and corresponding values in the
