...
public class GrizzlyService implements RequestDispatcher, PostConstruct, PreDestroy, EventListener, FutureProvider<Result<Thread>> {
    ...
    void registerContainerAdapters() {
        ...
        for (GrizzlyNetworkListenerRestartAdapter restartAdapter : serviceLocator.getAllServices(GrizzlyNetworkListenerRestartAdapter.class)) {
            restartAdapter.restartEndpoints();
        }
    }
