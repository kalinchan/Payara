...
public abstract class GFLauncher {
    ...
    private void setupProfilerAndJvmOptions(MiniXmlParser parser) throws MiniXmlParserException, GFLauncherException {
        ...
        JDK.Version jdkVersion = getConfiguredJdkVersion(javaExe);

        List<String> rawJvmOptions = new ArrayList<>();
        if (jdkVersion != null) {
     ...
     * @throws GFLauncherException
     */
    private JDK.Version getConfiguredJdkVersion(String javaExePath) throws GFLauncherException {
        try {
